...
def build_training_arguments(
    ...
    return TrainingArguments(
        ...
        seed=42,
        # NOTE: `group_by_length=True` (batches similar-length sequences to
        # reduce wasted padding compute) was tested against this version of
        # transformers and does NOT exist as an argument here - it may have
        # been removed/renamed. If your transformers version supports it,
        # it's worth adding back; check with:
        #   python -c "from transformers import TrainingArguments; import inspect; print('group_by_length' in inspect.signature(TrainingArguments.__init__).parameters)"
    )
